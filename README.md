# Trendpulse (Mini Project Module - 1)
...
1. A file at data/trends_YYYYMMDD.json
2. At least 100 stories inside it
3. A console message like: Collected 122 stories. Saved to data/trends_20240115.json
